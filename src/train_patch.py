...
from data.datasets import KneeSegDataset3DMulticlass, LengthEnabledGridPatchDataset
...
from monai.data import Dataset, GridPatchDataset, CacheDataset, PatchIter
...
def train(config, args) -> None:
    ...
    train_patch_dataset = LengthEnabledGridPatchDataset(
        data=train_dataset,
...
if __name__ == '__main__':
    ...
    wandb.agent(sweep_id, function=lambda: train(config=wandb.config, args=args))
